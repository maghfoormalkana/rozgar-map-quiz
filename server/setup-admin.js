...
const setupAdmin = async () => {
  try {
    ...
    if (!MONGODB_URI) { console.error('ERROR: MONGODB_URI not found in .env file'); console.error('Please create server/.env with your MongoDB Atlas connection string'); process.exit(1) }
    ...
    console.log('IMPORTANT: Delete this script after setup for security: rm server/setup-admin.js')
  } catch (error) {

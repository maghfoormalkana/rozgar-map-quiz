...
import { Trophy, CheckCircle, XCircle, MinusCircle, RotateCcw, Home, Award, HelpCircle } from 'lucide-react'
...
const ResultPage = () => {
  ...
  const circleProgress = 2 * Math.PI * 80 // radius 80
        ...
        <div className="card p-8 mb-6">
          <div className="text-center mb-8">
            ...
            <div className="relative w-48 h-48 mx-auto mb-6">
              <svg className="w-full h-full -rotate-90" viewBox="0 0 200 200">
                ...
                <circle
                  ...
                  strokeWidth="12"
                  strokeLinecap="round"
                  className={result.score >= 70 ? 'text-green-500' : result.score >= 50 ? 'text-yellow-500' : 'text-red-500'}
            ...
            <p className="text-gray-500 dark:text-gray-400">
              {result.batchName} &bull; {result.category}
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 mb-8">
            <div className="text-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
              <HelpCircle className="w-6 h-6 text-rozgar-blue mx-auto mb-2" />
          ...
          <div className="space-y-3 mb-8">
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
              ...
              <span className="text-sm font-semibold text-gray-600">{result.totalQuestions - result.correctAnswers - result.wrongAnswers}</span>
            </div>
